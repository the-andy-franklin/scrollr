...
const Navbar = () => (
  <nav className="flex flex-col flex-grow-0 pt-8 pr-4 text-right border-r border-white">
    <a
      href="#"
      className="text-lg flex gap-2 justify-end self-end items-center mb-3 hover:mb-2.5 hover:border-b-2 border-white"
    >
      <AiFillHome size={32} />
        Home
    </a>
